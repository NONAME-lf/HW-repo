$(document).ready(() => {
  ...
  //   Create and prepend custom gradient for stroke color
  const defs = document.createElement("defs");
  const lGradient = document.createElement("linearGradient");
  ...
  const chart = elem.donutty; // get alredy existant instance of our donut
