...
!function (e, t) {
  ...
  !function () {
        ...
        CHILD: function CHILD(p, e, t, h, g) {
          ...
          return 1 === h && 0 === g ? function (e) {
            ...
            if (l) {
              ...
              } else if (f && (d = a = (r = (i = e[k] || (e[k] = {}))[p] || [])[0] === S && r[1]), !1 === d) while (o = ++a && o && o[u] || (d = a = 0) || s.pop()) {
    ...
    function Y(e, t) {
      ...
      while (a) {
        for (o in n && !(r = y.exec(a)) || (r && (a = a.slice(r[0].length) || a), s.push(i = [])), n = !1, (r = m.exec(a)) && (n = r.shift(), i.push({
          ...
          !(r = N[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(), i.push({
            value: n,
            type: o,
            matches: r
          }), a = a.slice(n.length));
    ...
    function K(a, e, t) {
      ...
      return e.first ? function (e, t, n) {
        ...
        if (n) {
          ...
          if (1 === e.nodeType || c) if (i = e[k] || (e[k] = {}), u && fe(e, u)) e = e[s] || e;else {
    ...
    function te(e) {
      for (var i, t, n, r = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, u = K(function (e) {
        ...
        if (t = x.relative[e[s].type]) c = [K(J(c), t)];else {
      ...
      if (!a) {
        ...
        (a = u(e, (v = o, m = 0 < (y = i).length, b = 0 < v.length, r = function r(e, t, n, _r, i) {
          ...
          if (u += l, m && l !== u) {
            ...
            if (e) {
              if (0 < u) while (l--) {
                c[l] || f[l] || (f[l] = de.call(_r));
              }
              f = Z(f);
            }

            E.apply(_r, f), i && !e && 0 < f.length && 1 < u + y.length && ce.uniqueSort(_r);
          }
  ...
  (ce.fn.init = function (e, t, n) {
    ...
    if (n = n || E, "string" == typeof e) {
      ...
      if (r[1]) {
        if (t = t instanceof ce ? t[0] : t, ce.merge(this, ce.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), C.test(r[1]) && ce.isPlainObject(t)) for (r in t) {
  ...
  var R = function R(e, t, n, r, i, o, a) {
    ...
    if ("object" === x(n)) for (s in i = !0, n) {
      R(e, t, s, n[s], !0, o, a);
    } else if (void 0 !== r && (i = !0, v(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function t(e, _t, n) {
  ...
  $.uid = 1, $.prototype = {
    ...
    set: function set(e, t, n) {
      var r,
          i = this.cache(e);
      if ("string" == typeof t) i[B(t)] = n;else for (r in t) {
        i[B(r)] = t[r];
      }
      return i;
    },
  ...
  function Ae(e, t, n, r, i) {
    for (var o, a, s, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) {
      if ((o = e[p]) || 0 === o) if ("object" === x(o)) ce.merge(d, o.nodeType ? [o] : o);else if (Se.test(o)) {
    ...
    while (o = d[p++]) {
      if (r && -1 < ce.inArray(o, r)) i && i.push(o);else if (l = J(o), a = Ee(f.appendChild(o), "script"), l && ke(a), n) {
        c = 0;
  ...
  ce.event = {
    ...
    add: function add(t, e, n, r, i) {
      ...
      if (F(t)) {
        ...
        while (l--) {
          p = g = (s = De.exec(e[l]) || [])[1], h = (s[2] || "").split(".").sort(), p && (f = ce.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = ce.event.special[p] || {}, c = ce.extend({
            type: p,
            origType: g,
            data: r,
            handler: n,
  ...
  function Be(n, r, i, o) {
    ...
    if (f && (t = (e = Ae(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
      ...
      if (s) for (l = a[a.length - 1].ownerDocument, ce.map(a, Ie), c = 0; c < s; c++) {
  ...
  ce.extend({
    ...
    clone: function clone(e, t, n) {
      var r,
          ...
          c = e.cloneNode(!0),
          f = J(e);
      if (!(le.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ce.isXMLDoc(e))) for (a = Ee(c), r = 0, i = (o = Ee(e)).length; r < i; r++) {
      ...
      if (t) if (n) for (o = o || Ee(e), a = a || Ee(c), r = 0, i = o.length; r < i; r++) {
        We(o[r], a[r]);
      } else We(e, c);
  ...
  function ot(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2) {
      "margin" === n && (l += ce.css(e, n + G[a], !0, i)), r ? ("content" === n && (u -= ce.css(e, "padding" + G[a], !0, i)), "margin" !== n && (u -= ce.css(e, "border" + G[a] + "Width", !0, i))) : (u += ce.css(e, "padding" + G[a], !0, i), "padding" !== n ? u += ce.css(e, "border" + G[a] + "Width", !0, i) : s += ce.css(e, "border" + G[a] + "Width", !0, i));
    }
    ...
    ce.cssHooks[u] = {
      ...
      set: function set(e, t, n) {
        var r,
            ...
            s = n ? ot(e, u, n, a, i) : 0;
        return a && o && (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ot(e, u, "border", !1, i) - 0.5)), s && (r = Y.exec(t)) && "px" !== (r[3] || "px") && (e.style[u] = t, t = ce.css(e, u)), it(0, t, s);
      }
    };
  ...
  ce.extend(ce.event, {
    trigger: function trigger(e, t, n, r) {
      ...
      if (o = f = a = n = n || m, 3 !== n.nodeType && 8 !== n.nodeType && !gt.test(p + ce.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, (e = e[ce.expando] ? e : new ce.Event(p, "object" == _typeof(e) && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : ce.makeArray(t, [e]), c = ce.event.special[p] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
        if (!r && !c.noBubble && !y(n)) {
        ...
        while ((o = d[i++]) && !e.isPropagationStopped()) {
          f = o, e.type = 1 < i ? s : c.bindType || p, (l = (_.get(o, "events") || Object.create(null))[e.type] && _.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && F(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault());
        }
